...
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@172.31.72.84 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@172.31.73.252 "echo $id2translate >>~/.ssh/authorized_keys"
