...
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@172.31.7.131 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@172.31.10.158 "echo $id2translate >>~/.ssh/authorized_keys"
