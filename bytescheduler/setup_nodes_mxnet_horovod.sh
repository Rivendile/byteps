...
ssh -i ~/byteps/bytescheduler/bytescheduler-20201004.pem ubuntu@172.31.25.212 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler/bytescheduler-20201004.pem ubuntu@172.31.20.158 "echo $id2translate >>~/.ssh/authorized_keys"
