...
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@172.31.10.73 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@172.31.6.196 "echo $id2translate >>~/.ssh/authorized_keys"
