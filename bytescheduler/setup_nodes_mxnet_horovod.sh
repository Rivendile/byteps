...
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@172.31.0.225 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@172.31.6.169 "echo $id2translate >>~/.ssh/authorized_keys"
